...
p(a(href = "https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html", "(source)")),
    ...
    # text.
p("The graph shows that the people in the 1% have seen a rise in their income by", strong("6%"),"since 1980","while in the past, its the middle class that sees the largest increase in wealth, in recent times the income for the middle class has ",em("(remained generally the same).")),
